...
def get_args():
    ...
    parser.add_argument("--metalst", type=str, default="", help="Optional manifest (.lst) override; empty = full hardcoded meta.lst")
...
def main():
    ...
    metalst = args.metalst if getattr(args, "metalst", "") else (rel_path + f"/data/seedtts_testset/{lang}/meta.lst")  # seed-tts testset
    print(f"[eval-seedtts] using metalst = {metalst}")
